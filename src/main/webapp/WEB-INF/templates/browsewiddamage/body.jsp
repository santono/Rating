        ...
        jQuery('.delrecbutton').on('click',
                ...
                function () {
                    ...
                    if (confirm('Удалить запись '+nam+'?')) {
                        var AJAXadr="widdamage/delrec/" + id;
