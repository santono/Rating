...
<div class="ui large top fixed hidden menu">
  <div class="ui container">
    <div class="right menu">
      <div class="item">
        <a href="<spring:url value='mainpage' />" class="ui button">Вход</a>
      </div>
      <div class="item">
          <a href="<spring:url value='user/register' />" class="ui primary button">Регистрация</a>
      </div>
    </div>
  </div>
</div>
...
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment" >
    ...
    <div class="ui container">
      <div class="ui large secondary inverted pointing menu">
        ...
        <div class="right item">
          <a href="<spring:url value='mainpage' />" class="ui inverted button">Вход</a>
          <a href="<spring:url value='/user/register' />" class="ui inverted button">Регистрация</a>
        </div>
      </div>
    </div>
    ...
    <div class="ui text container" >
      ...
      <a href="mainpage" class="ui huge primary button">Вход<i class="right arrow icon"></i></a>
    </div>
