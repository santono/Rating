<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %><%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" language="java" %><%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %><%@ taglib uri="http://www.springframework.org/security/tags" prefix="sec" %>
<!DOCTYPE html>
<html lang="en">
...
--%>
        ...
        <div class="ui vertical inverted sidebar menu">
          ...
          <sec:authorize access="isAnonymous()">
            ...
            <%--
        <a href="<spring:url value='user/register' />" class="item">Регистрация_2</a>
            --%>
        </div>
...
<%--
            <a href="<spring:url value='/user/register' />" class="ui inverted button canload">Регистрация 1</a>
--%>
        </div>
      </div>
    </div>
