...
@Component
public class RoadDetValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        RoadDetEntity row = (RoadDetEntity) target;
...
/*
        ...
        if (!((yy >= minLimitYY) && (xx < maxLimitYY))) {
            errors.rejectValue("yy", "yy.WrongLongitude", "Неверно указана долгота точки. (" + minLimitYY + " ... " + maxLimitYY + ")");
        }
